...
public class CertGen {
    public static X509Certificate genV1(SubjectPublicKeyInfo
                                                subjectPublicKeyInfo, PrivateKey privateKey, X500Name issuer, X500Name subject, BigInteger serial, Date notBefore, Date notAfter, List<Extension> extensionList) throws CertIOException {
    ...
    public static X509Certificate genV1(PublicKey publicKey, PrivateKey
            privateKey, X500Name issuer, X500Name subject, BigInteger serial, Date notBefore, Date notAfter, List<Extension> extensionList) throws CertIOException {
    ...
    public static X509Certificate gen(PublicKey publicKey, PrivateKey privateKey, X500Name issuer, X500Name subject, BigInteger serial, Date notBefore, Date notAfter, List<Extension> extensionList) throws CertIOException {
        SubjectPublicKeyInfo subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance(publicKey.getEncoded());
